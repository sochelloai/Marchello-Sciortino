...
export async function onRequestPost(context) {
    ...
    const tagName = cleanEnvVar(getEnvVal(env, "CLICKFUNNELS_AIM_TAG_NAME")) || "Waitlist (Accessible AIM)";
    ...
    try {
        ...
        if (contactResponse.ok) {
            ...
            if (!contactId) {
                ...
                throw new Error(`[DEBUG] CF Create failed. URL: ${createContactUrl}. Status: ${contactResponse.status}. Body: ${errBody}`);
            }
        }
        ...
        return new Response(JSON.stringify({
            ...
            contactId: contactId,
            tagId: tagId,
            message: "Lead waitlisted and tagged successfully in ClickFunnels."
        }), {
            status: 200,
            headers: { 
                "Content-Type": "application/json",
